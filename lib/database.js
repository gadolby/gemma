...
module.exports.Database = async function(filename) {
    ...
    let insertAlternates = async function(entry) {
    ...
    let insertVariants = async function(entry) {
    ...
    let insertVariantCall = async function(entry) {
        return Promise.all([ insertAlternates(entry), insertVariants(entry) ]);
    };

    let insertEnvironment = async function(env) {
    ...
    let insertGene = async function(entry) {
    ...
    let insertSubgene = async function(entry) {
    ...
    let insertGeneFeature = async function(entry) {
